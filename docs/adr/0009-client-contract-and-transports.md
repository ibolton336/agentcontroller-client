# ADR 0009: Verified client contract and layered transports for AgentRun UIs
...
- **Numbering:** continues the konveyor/agentic-controller ADR series, which
  reached 0008. Filed as 0004 in this repo until 2026-08-05; renumbered to
  0009 because upstream 0004 is "OpenShell as Execution Interface". The old
  path is kept as a pointer — it is cited in posted konveyor#22 comments.
