# ADR 0010: Platform-resolved agent params (param sources)

- **Status:** proposed (prototype verified in this repo)
- **Date:** 2026-07-08
- **Relates to:** ADR 0009 (client contract), konveyor/agentic-controller#22/#24,
  the APB `plans`/parameter-metadata precedent
- **Numbering:** continues the konveyor/agentic-controller ADR series, which
  reached 0008. Filed as 0005 in this repo until 2026-08-05; renumbered to
  0010 because upstream has no 0005 and the collision blocked contributing
  it. The old path is kept as a pointer — it is cited in posted
  konveyor#22 comments.
